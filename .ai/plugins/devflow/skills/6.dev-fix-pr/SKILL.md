...
Call `gh-fix-pr` skill from `.ai/plugins/githubflow/skills/gh-fix-pr/SKILL.md` to push and resolve threads. Then call `jira-move` with `KEY` and milestone `code-review` (non-blocking).
