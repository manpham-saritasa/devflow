...
| dev-plan | `.ai/plugins/devflow/skills/2.dev-plan/` | `dev-plan`, `devplan` | Create execution plan from task evidence |
...
| dev-ship | `.ai/plugins/devflow/skills/5.dev-ship-pr-jira/` | `dev-ship`, `dev-ship-pr-jira` | Create PR + comment Jira |
...
| dev-review-pr | `.ai/plugins/devflow/skills/dev-review-pr/` | `review-pr`, `reviewpr` | Review any PR across 8 dimensions |
...
| jira-task | `.ai/plugins/jiraflow/skills/jira-mine/` | `jtask` | List assigned tasks by status group |
...
| grill-me | `.ai/skills/grill-me/` | `grill me`, `grill this` | Interview relentlessly — triggers on "should I..." and "why..." questions |
